...
---
 ...
 <a href="https://github.com/openfl/learn-openfl/edit/master/docs/advanced_setup/linux.md" class="btn btn-default pull-right" style="margin-top: 16px" role="button" target="_blank"><span class="glyphicon glyphicon-pencil"></span></a>
...
{% sidebar %}* [Documentation](/learn/docs/)
   ...
   * [Advanced Setup](/learn/docs/advanced-setup/)
      ...
      * [__Linux__](/learn/docs/advanced-setup/linux/)
