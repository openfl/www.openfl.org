...
---
 ...
 <a href="https://github.com/openfl/learn-openfl/edit/master/docs/command-line_tools/project_files/hxp_format.md" class="btn btn-default pull-right" style="margin-top: 16px" role="button" target="_blank"><span class="glyphicon glyphicon-pencil"></span></a>
...
{% sidebar %}* [Documentation](/learn/docs/)
   ...
   * [Command-Line Tools](/learn/docs/command-line-tools/)
      ...
      * [Project Files](/learn/docs/command-line-tools/project-files/)
         ...
         * [__HXP Format__](/learn/docs/command-line-tools/project-files/hxp-format/)
