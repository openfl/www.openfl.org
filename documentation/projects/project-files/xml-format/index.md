...
If you would prefer to set the ID for your asset file yourself, use a name attribute. This only applies to asset nodes which point to a file, not a directory path.
