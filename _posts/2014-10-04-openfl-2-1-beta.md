 ...
 * [OpenFL](http://www.openfl.org/builds/openfl/openfl-2.1.0-beta-73-g3679f01.zip)
 * [Lime](http://www.openfl.org/builds/lime/lime-2.0.0-alpha-68-g1aca5d1.zip)
...
After you download each zip, use "haxelib local" to install each one:
    ...
    haxelib local openfl-2.1.0-beta-73-g3679f01.zip
    haxelib local lime-2.0.0-alpha-68-g1aca5d1.zip
