...
In the newer OpenFL renderer, we have set aside the software renderer in favor of hardware rendering. This has brought many performance benefits, but the accuracy at times has left more to be desired.
