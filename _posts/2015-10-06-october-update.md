...
The summer was packed with new improvements, and fall looks to be no exception. We are excited about OpenFL, Lime, SWF and other features that are coming. Let me take a moment again to thank our [Patreon](https://patreon.com/openfl) supporters. You are key contributors to supporting of the ongoing development of OpenFL and the costs of the build servers (and other expenses).

Use OpenFL, support us on [Patreon](https://patreon.com/openfl) and spread the word!

It is our hope that OpenFL continues to grow and better suit/serve your dreams and your vision.

_just one more thing..._

Have you seen the demo videos yet for the upcoming [console support](https://www.youtube.com/watch?v=rnJ3qkwzcqw&list=PLF1S8k0g8YOXhS0d0JnPDg9Cn9CSATudc&index=10)? Exciting!
